...
* 設定成功報告
- [2021-04-12 Mon]: Windows 10 Home, Coq 8.13.2, MathComp 1.12 (WSL2)
...
- 方法3: WSL 2 + opam (WSL 2でopamを用いてCoqをコンパイルします)
*** 事前準備
...
**** [[https://docs.microsoft.com/ja-jp/windows/wsl/install-win10][方法3: WSL 2]] の設定
...
- [[https://github.com/math-comp/mathcomp-history-before-github][SSReflect/MathCompの古いバージョン]]
...
| *１つタクティックのUndo*           | CTRL-C CTRL-U        | CTRL ALT \uparrow    |                |
| *カーソルまでのタクティックの実行* | CTRL-C CTRL-ENTER    | CTRL ALT \rightarrow |                |
...
- Proof Generalのメニュー:
  + Coq \rightarrow 3 Windows mode layout \rightarrow hybrid
...
* [参考のため] Coq/SSReflect/MathCompの設定 Windowsの場合 過去の設定報告メモ
